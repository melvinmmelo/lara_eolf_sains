...
*   **Tailwind CSS:** A utility-first CSS framework used for custom styling and modifications. It is integrated via the `resources/css/app.css` file and processed by Vite.

*   **Alpine.js:** A lightweight JavaScript framework used for adding interactivity to the UI. It is likely included directly in the Blade templates and used for small, client-side interactions.
