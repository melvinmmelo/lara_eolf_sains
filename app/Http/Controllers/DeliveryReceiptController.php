...
class DeliveryReceiptController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $outbounds = Inbound::completed()->branch(session('branch_code'))->whereNull('delivery_receipt_id')->withProducts()->notDRYet()->get();
    ...
    public function store(Request $request)
    {
        ...
        activity('delivery-receipt')
            ->performedOn($deliveryReceipt)
            ->log("DR $deliveryReceipt->code was generated by $deliveryReceipt->generated_by.");
