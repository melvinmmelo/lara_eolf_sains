...
@section('contents')
    ...
    <section class="content">
                        ...
                        @foreach ($storeinfos as $storeinfo)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{{ route('store-info.destroy', $storeinfo->id) }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="/store-info/store">
                            @csrf
                            Customer ID:
                            <input type="type" class="form-control" name="customer_id"
                                value="{{ request()->query('customer_id') }}" readonly required>
        ...
        <div class="modal fade" id="editStoreModal" tabindex="-1" aria-labelledby="storeModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('store-info.update') }}">
                            ...
                            @method('PATCH')
                            Customer ID:
                            <input type="type" class="form-control" name="customer_id" id="customer_id" readonly
                                required>
                            Store ID:
...
@section('custom_js')
    <script>
        function setToUpdatestoreinfo(uid, cusid, storename2, contactno2, reg, prov, city, brgy, subv, long, lat, lis, leng,
            rem2) {
