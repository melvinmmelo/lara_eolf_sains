...
<body class="container">
    ...
    <div class="row">
        ...
        <div class="hero-unit">
            ...
            <a id="link-ghp" class="btn btn-primary" href="https://github.com/istvan-ujjmeszaros/bootstrap-duallistbox"
                target="_blank"><span class="glyphicon glyphicon-link"></span> Github project page</a>
        </div>

        <p>
            Bootstrap Dual Listbox is a responsive dual listbox widget optimized for Twitter Bootstrap. It works on all
            modern browsers and on touch devices.
        </p>
    ...
    <p>
        ...
        selector. The selector can be any element, not just selects. When the method is called on a selector other than
        a select, then all select childrens are converted into dual list boxes.
    </p>
...
var demo2 = $('.demo2').bootstrapDualListbox({
  ...
  nonSelectedFilter: 'ion ([7-9]|[1][0-2])'
    ...
    <p>
        If there are some highlighted options in the lists, then calling the <code>refresh</code> method with the
        optional <code>true</code> parameter results the highlights to be removed. Example usage:
        <code>demo2.bootstrapDualListbox('refresh', true);</code><br>
...
$("#demo2-add-clear").click(function() {
  ...
  demo2.bootstrapDualListbox('refresh', true);
    ...
    <table class="table table-striped table-bordered docs">
        ...
        <tbody>
            <tr>
                ...
                <td><code><strong>false</strong></code>: set this to <code>true</code> if you want graphic compatibility
                    with Bootstrap 2.</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><code><strong>'Filter'</strong></code>: the placeholder for the <code>input</code> element for
                    filtering elements.</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><code><strong>true</strong></code>: determines whether to move <code>options</code> upon selection.
                    This option is forced to <code>true</code> on the Android browser.</td>
            </tr>
            <tr>
                <td><code>preserveSelectionOnMove</code></td>
                <td><code><strong>false</strong></code>: can be <code>'all'</code> (for selecting both moved elements
                    and the already selected ones in the target list) or <code>'moved'</code> (for selecting moved
                    elements only)</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><code><strong>false</strong></code>: can be a string specifying the name of the non selected list.
                </td>
            </tr>
            <tr>
                <td><code>helperSelectNamePostfix</code></td>
                <td><code><strong>'_helper'</strong></code>: The added selects will have the same name as the original
                    one, concatenated with this string and 1 (for the non selected list, e.g. element_helper1) or 2 (for
                    the selected list, e.g. element_helper2).</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><code><strong>''</strong></code>: initializes the dual listbox with a filter for the non selected
                    elements. This is applied only if <code>showFilterInputs</code> is set to <code>true</code>.</td>
            </tr>
            <tr>
                <td><code>selectedFilter</code></td>
                <td><code><strong>''</strong></code>: initializes the dual listbox with a filter for the selected
                    elements. This is applied only if <code>showFilterInputs</code> is set to <code>true</code>.</td>
            </tr>
            <tr>
                <td><code>infoText</code></td>
                <td><code><strong>'Showing all {0}'</strong></code>: determines which string format to use when all
                    options are visible. Set this to <code>false</code> to hide this information. Remember to insert the
                    <code>{0}</code> placeholder.</td>
            </tr>
            <tr>
                <td><code>infoTextFiltered</code></td>
                <td><code><strong>'&lt;span class=&quot;label label-warning&quot;&gt;Filtered&lt;/span&gt; {0} from
                            {1}'</strong></code>: determines which element format to use when some element is filtered.
                    Remember to insert the <code>{0}</code> and <code>{1}</code> placeholders.</td>
            </tr>
            <tr>
                <td><code>infoTextEmpty</code></td>
                <td><code><strong>'Empty list'</strong></code>: determines the string to use when there are no options
                    in the list.</td>
            </tr>
            <tr>
                <td><code>filterOnValues</code></td>
                <td><code><strong>false</strong></code>: set this to <code>true</code> to filter the options according
                    to their values and not their HTML contents.</td>
            </tr>
            <tr>
                <td><code>eventMoveOverride</code></td>
                <td><code><strong>false</strong></code>: set this to <code>true</code> to allow your own implementation
                    of the move event.</td>
            </tr>
            <tr>
                <td><code>eventMoveAllOverride</code></td>
                <td><code><strong>false</strong></code>: set this to <code>true</code> to allow your own implementation
                    of the moveall event.</td>
            </tr>
            <tr>
                <td><code>eventRemoveOverride</code></td>
                <td><code><strong>false</strong></code>: set this to <code>true</code> to allow your own implementation
                    of the remove event.</td>
            </tr>
            <tr>
                <td><code>eventRemoveAllOverride</code></td>
                <td><code><strong>false</strong></code>: set this to <code>true</code> to allow your own implementation
                    of the removeall event.</td>
            </tr>
        </tbody>
    </table>
    ...
    <p>You can modify the behavior and aspect of the dual listbox by calling its methods, all of which accept a
        <code>value</code> and a <code>refresh</code> option. The <code>value</code> determines the new parameter value,
        while <code>refresh</code> (optional, defaults to <code>false</code>) tells whether to update the plugin UI or
        not.</p>
...
$(selector).bootstrapDualListbox(methodName, parameter);</pre>
    ...
    <p><strong>Note</strong>: when making multiple chained calls to the plugin, set <code>refresh</code> to true to the
        last call only, in order to make a unique UI change; alternatively, you can also call the <code>refresh</code>
        method as your last one.</p>
