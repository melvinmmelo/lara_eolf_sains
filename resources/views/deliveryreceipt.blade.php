                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label class="form-label" for="inbound_id"><i style="color:red">*</i>Customer</label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="generated_by" value=" {{ auth()->user()->fullName }}" required readonly>
                                    </div>
                                </div>
                            </div>
                            {{-- <div class="form-group">
