                        ...
                        <tr>
                            ...
                            <td> <!-- Add a delete button -->
                                <form method="POST" action="{{ route('badOrders.destroy', $badOrder['bo_id']) }}">
                                    ...
                                    <button type="button" class="btn btn-success btn-print" data-bo-id="{{ $badOrder['bo_id'] }}" onclick="printPage(this)">
...
fetch(`/getBoDetails?boId=${boId}`)
    ...
    .then(data => {
        ...
        mywindow.document.write('<table width="100%">');
        mywindow.document.write('<tr><td align="left">Sub-total:</td><td align="right">' + formatNumber(totalAmount) + '</td></tr>');
        mywindow.document.write('<tr><td align="left">BO Amount Due:</td><td align="right">' + formatNumber(lessamt) + '</td></tr>');
        mywindow.document.write('<tr><td align="left">BO (%):</td><td align="right">' + boperc + '%</td></tr>');
        mywindow.document.write('<tr><td align="left">Total Amount:</td><td align="right">' + formatNumber(netamt) + '</td></tr>');
        mywindow.document.write('</table>');
